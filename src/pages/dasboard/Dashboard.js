...
export default function Dashboard() {
  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <Box sx={{ display: 'flex' }}>
        <CssBaseline />
        <AppBar position="absolute" open={open} sx={{ bgcolor: '#00695C' }}>
          <Toolbar
            sx={{
              pr: '24px', // keep right padding when drawer closed
              justifyContent: open ? 'center' : 'flex-end', // Center the avatar if the drawer is open
            }}
          >
            <IconButton
              edge="start"
            ...
            <Typography
              ...
              sx={{
                flexGrow: 1,
                textStroke: '2px #00695C', // Dark green outline (adjust thickness as needed)
                textStrokeWidth: '2px', // Ensure outline width matches stroke size
                color: 'white', // White text color
                fontWeight: 'bold', // Increase font weight for thickness
              }}
            >
              VisualGreen
            </Typography>
